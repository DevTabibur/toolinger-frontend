...
const dummyBlogs = [
  ...
  },
  {
    ...
    excerpt:
      "Bring your UI to life with smooth animations using Framer Motion.",
    category: "Development",
    date: "2024-05-15",
...
const BlogsClientPage = ({ page1 }: any) => {
  ...
  const filteredBlogs = blogs.filter((blog) => {
    const matchesCategory =
      activeTab === "all" || blog.category?.name.toLowerCase() === activeTab;
    const matchesSearch =
            ...
            p === "..." ? (
              ...
              <button
                ...
                className={classNames(
                  ...
                  page === p
                    ? "bg-gradient-to-r from-[#005c82] to-[#00dbed] text-white font-bold"
                    : ""
                )}
              >
                {p}
    ...
    <>
      ...
      <section className="relative w-full bg-gradient-to-br from-[#00dbed] via-[#005c82] to-[#101827] py-12 md:py-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 flex flex-col items-center text-center">
          ...
          >
            Welcome to{" "}
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#00dbed] to-[#005c82]">
              Toolinger Blog
            </span>
          </motion.h2>
          <motion.p
          ...
          >
            Insights, tutorials, and stories from the world of development,
            design, and productivity. Stay ahead with the latest trends, tips,
            and inspiration for creators and innovators.
          </motion.p>
        </div>
      </section>
                  ...
                  {activeTab !== "all" && (
                    <>
                      ...
                      <span className="font-semibold">
                        {categories.find(
                          (c) => c.name.toLowerCase() === activeTab
                        )?.name || activeTab}
                      </span>
                    </>
                  )}
          ...
          <aside className="w-full lg:w-80 flex-shrink-0 space-y-8">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl shadow border border-gray-200 dark:border-gray-800 p-6">
              ...
              <ul className="space-y-2">
                ...
                {loading ? (
                  <li>
                    <span className="px-3 py-2 text-gray-400 block">
                      Loading...
                    </span>
                  </li>
                ) : (
      ...
      <div className="container mx-auto px-4 py-24">
        <div
          ...
          dangerouslySetInnerHTML={{ __html: page1?.data?.pageContent || "" }}
        ></div>
      </div>
