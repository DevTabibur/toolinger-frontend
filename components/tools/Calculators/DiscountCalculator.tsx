        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 mb-8">
          ...
          <div className="md:col-span-7 col-span-1">
            <div className=" border rounded-lg p-4 mb-8 bg-white dark:bg-gray-900 shadow-sm dark:border-gray-700">
              <h1 className="text-2xl font-bold mb-4 text-center">Discount Calculator</h1>
              <p className="text-center mb-6">
                To use the <b>Discount Calculator</b>, enter the original price and the discount percentage. Then press the <b>Calculate</b> button to see your savings and the final price.
              </p>
