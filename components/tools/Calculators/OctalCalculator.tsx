...
function calculateOctal(a: string, b: string, op: string): string {
...
const OctalCalculator = (props: { article?: any, seo?: any }) => {
    ...
    const handleCalculate = () => {
        setResult(calculateOctal(hexA, hexB, operation));
    };
        ...
        <>
            ...
            <div className="container mx-auto px-4 py-4">
                <nav className="flex items-center space-x-2 text-sm">
                    ...
                    <ChevronRight className="h-4 w-4 text-muted-foreground" />
                    <span className="text-foreground font-medium">Octal Calculator</span>
                </nav>
            </div>
...
export default OctalCalculator;
