          ...
          <div className="md:col-span-7 col-span-1">
            <div className=" border rounded-lg p-4 mb-8 bg-white dark:bg-gray-900 shadow-sm dark:border-gray-700">
              ...
              <p className="text-center mb-6">
                To use toolinger <b>Adsense Calculator</b>, Enter Total Page
                Impressions, Click Through Rate (CTR) and CPC. After that press{" "}
                ...
                >
                  <div className="flex flex-col md:flex-row items-center md:space-x-4 mb-6 space-y-4 md:space-y-0">
                    <div className="flex flex-col w-full">
                      <label
                        className="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-1"
                        htmlFor="pageImpressions"
                      >
                        Page Impressions
                      </label>
                      <input
            ...
            {result && (
              <div className="overflow-x-auto mt-8">
                <table className="min-w-full bg-white dark:bg-gray-800 border rounded-lg">
                  <thead>
                    <tr>
                      <th className="py-2 px-4 bg-cyan-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100 border">
                        Period
                      </th>
                      <th className="py-2 px-4 bg-cyan-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100 border">
                        Earnings
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="border px-4 py-2">
                        {formatCurrency(result.dailyEarnings)}
                      </td>
                      <td className="border px-4 py-2">
                        {Math.round(result.dailyClicks)}
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border px-4 py-2">
                        {Math.round(result.monthlyClicks)}
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="border px-4 py-2">
                        {Math.round(result.yearlyClicks)}
                      </td>
                    </tr>
                  </tbody>
                </table>
            ...
            <ArticleRenderer file="adsense_calculator.html" />
          </div>
