          ...
          <div className="md:col-span-7 col-span-1 ">
            <div className="border rounded-lg p-4 mb-8 bg-white dark:bg-gray-900 shadow-sm dark:border-gray-700">
              ...
              <p className="text-center text-muted-foreground mb-6 text-sm">
                To use the Website Link Count Checker, enter a webpage URL in
                the box below and click the button to see how many total,
                internal, and external links are found on the page.
              </p>
            ...
            <ArticleRenderer file="links_count_checker.html" />
          </div>
