          ...
          <div className="md:col-span-7 col-span-1 ">
            <div className=" border rounded-lg p-4 mb-8 bg-white dark:bg-gray-900 shadow-sm dark:border-gray-700">
              ...
              <p className="text-center mb-6 text-gray-700 dark:text-gray-300">
                To use Toolinger <b>Online URL Encode/Decode</b>, Paste Urls in
                the input box given below and click on <b>Encode/Decode</b>{" "}
                Button.
              </p>
              <div className="mb-4">
                <textarea
                ...
                <table className="min-w-full border border-gray-300 dark:border-gray-700 rounded">
                  <thead>
                    <tr className="bg-green-100 dark:bg-green-900">
                      <th className="px-4 py-2 border-b border-gray-300 dark:border-gray-700 text-left text-gray-900 dark:text-gray-100">
                        Sr No
                      </th>
                      <th className="px-4 py-2 border-b border-gray-300 dark:border-gray-700 text-left text-gray-900 dark:text-gray-100">
                        Result
                  ...
                  <tbody>
                    {results.map(({ sr, result }) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-2 border-b border-gray-200 dark:border-gray-700 text-gray-800 dark:text-gray-200 break-all">
                          {result}
                        </td>
                      </tr>
                    ))}
            ...
            <ArticleRenderer file="url_encoder_decoder.html" />
          </div>
