...
export default function TextToHandWriting(props: { article?: any; seo?: any }) {
  ...
  const fontFamily =
    HANDWRITING_FONTS.find((f) => f.value === font)?.fontFamily || "cursive";
          ...
          <div className="md:col-span-8 col-span-12">
            <div className="border rounded-lg p-4 mb-8 bg-white dark:bg-gray-900 shadow-sm dark:border-gray-700">
              ...
              <p className="text-center mb-6 text-gray-600 dark:text-gray-300">
                Paste your text and generate a realistic handwriting image.
                Customize font, ink color, and page style.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                  <div
                    ref={previewRef}
                    className={`p-8 min-h-[400px] rounded shadow ${getPageStyleClass(
                      pageStyle
                    )}`}
                    style={{
                      fontFamily,
            ...
            <ArticleRenderer file="text_to_handwriting.html" />
          </div>
