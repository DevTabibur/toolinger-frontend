            ...
            <div className="container mx-auto p-4">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 mb-8">
                    ...
                    <div className="md:col-span-7 col-span-1 bg-white dark:bg-gray-800 rounded shadow p-4">
                        <h1 className="text-2xl font-bold text-center mb-2 text-gray-900 dark:text-gray-100">Text to PDF Counter</h1>
                        <div className="max-w-2xl mx-auto mt-4 p-4 rounded-lg shadow bg-inherit border border-zinc-200 dark:border-zinc-800">
                            {/* Toolbar */}
                        ...
                        <div className="max-w-2xl mx-auto mt-6 text-xs text-zinc-500 px-4">
                            <p>
