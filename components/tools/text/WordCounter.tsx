                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 mb-8">
                    ...
                    <div className="md:col-span-7 col-span-1 bg-white dark:bg-gray-800 rounded shadow p-4">
                        ...
                        <p className="text-center mb-6 text-gray-600 dark:text-gray-300">
                            To use <b>word counter</b>, copy and paste text in the input box below or upload DOC, PDF or DOCX to count words and characters.
                        </p>
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
                            <div className={statBoxStyle}>
                                <span className="text-2xl font-bold text-gray-900 dark:text-gray-100">{words}</span>
                                <span className="uppercase text-xs text-gray-500 dark:text-gray-400 font-semibold mt-1">Words</span>
                            </div>
                            <div className={statBoxStyle}>
                                <span className="text-2xl font-bold text-gray-900 dark:text-gray-100">{characters}</span>
                                <span className="uppercase text-xs text-gray-500 dark:text-gray-400 font-semibold mt-1">Characters</span>
                            </div>
                            <div className={statBoxStyle}>
                                <span className="text-2xl font-bold text-gray-900 dark:text-gray-100">{sentences}</span>
                                <span className="uppercase text-xs text-gray-500 dark:text-gray-400 font-semibold mt-1">Sentence</span>
                            </div>
                            <div className={statBoxStyle}>
                                <span className="text-2xl font-bold text-gray-900 dark:text-gray-100">{readTime}</span>
                                <span className="uppercase text-xs text-gray-500 dark:text-gray-400 font-semibold mt-1">Read Time <span className="lowercase">sec</span></span>
                            </div>
                        </div>
