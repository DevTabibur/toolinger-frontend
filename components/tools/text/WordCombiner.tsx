...
export default function WordCombiner(props: { article?: any; seo?: any }) {
          ...
          <div className="md:col-span-7 col-span-1">
            <div className=" border rounded-lg p-4 mb-8 bg-white dark:bg-gray-900 shadow-sm dark:border-gray-700">
              ...
              <p className="text-center text-gray-600 dark:text-gray-300 mb-4">
                To use toolinger <b>Word Combiner</b>, type your keywords in the
                box and press <b>Combine</b> (one word on each line)
              </p>
              <div className="border border-dashed border-gray-300 dark:border-gray-700 p-4">
                <div className="text-center text-xs text-gray-500 dark:text-gray-400 mb-3">
                  Type your keywords in the box and press Combine! (one word on
                  each line)
                </div>
            ...
            <ArticleRenderer file="word_combiner.html" />
          </div>
