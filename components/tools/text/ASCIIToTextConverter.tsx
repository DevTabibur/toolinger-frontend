...
export default function ASCIIToTextConverter(props: {
  article?: any;
  seo?: any;
}) {
          ...
          <div className="md:col-span-7 col-span-1">
            <div className=" border rounded-lg p-4 mb-8 bg-white dark:bg-gray-900 shadow-sm dark:border-gray-700">
              ...
              <p className="text-center text-gray-600 dark:text-gray-300 mb-6">
                To use toolinger <b>Text to ASCII Converter</b>, enter the text
                in the text box below.
              </p>
              <div className="border border-dashed dark:border-gray-300 rounded shadow p-4 md:p-6 max-w-3xl mx-auto">
                <div className="flex flex-col md:flex-row gap-4 items-center">
                  ...
                  <div className="flex-1 w-full flex flex-col">
                    ...
                    <textarea
                      ...
                      placeholder={
                        leftType === "ascii"
                          ? "Enter ASCII codes (comma or space separated)"
                          : "Enter text"
                      }
                    />
                  ...
                  <div className="flex-1 w-full flex flex-col">
                    <textarea
                      ...
                      readOnly
                      placeholder={
                        leftType === "ascii" ? "Text output" : "ASCII output"
                      }
                    />
                    <div className="text-xs text-gray-500 dark:text-gray-400 mt-1 text-right">
                      Output
            ...
            <ArticleRenderer file="text_to_ascii.html" />
          </div>
