...
export async function generateMetadata(): Promise<Metadata> {
    ...
    const fallbackMetaTitle = 'Contact Us - Toolinger | Get in Touch with Our Team';
    const fallbackMetaDescription = 'Reach out to Toolinger for support, inquiries, or feedback. Our team is here to assist you with any questions or concerns you may have.';
