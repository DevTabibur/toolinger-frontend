...
export async function generateMetadata(): Promise<Metadata> {
    ...
    const fallbackMetaTitle = 'Privacy Policy - Toolinger | Your Data, Your Trust';
    const fallbackMetaDescription = 'Read Toolinger’s Privacy Policy to learn how we protect your data, respect your privacy, and ensure a secure experience on our platform.';
