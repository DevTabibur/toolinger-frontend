...
export async function generateMetadata(): Promise<Metadata> {
    ...
    const fallbackMetaTitle = 'Register - Toolinger | Create Your Account';
    const fallbackMetaDescription = 'Register for a Toolinger account to access premium tools, manage your favorites, and enjoy a personalized experience.';
