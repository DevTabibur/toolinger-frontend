...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const fallbackMetaTitle = 'Register - Toolinger | Create Your Free Account';
  const fallbackMetaDescription = 'Create your Toolinger account to access 200+ free online tools, save your favorites, and enjoy a personalized experience.';
