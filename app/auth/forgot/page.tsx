...
export async function generateMetadata(): Promise<Metadata> {
    ...
    const fallbackMetaDescription = 'Reset your Toolinger account password to regain access to premium tools, manage your favorites, and continue your personalized experience.';
