...
export async function generateMetadata(): Promise<Metadata> {
    ...
    const fallbackMetaTitle = 'Categories - Toolinger | Explore Tools by Category';
    const fallbackMetaDescription = 'Browse Toolinger’s curated categories to discover the best tools for your needs. Find, compare, and explore tools by category for a tailored experience.';
