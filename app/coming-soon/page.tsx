...
export async function generateMetadata(): Promise<Metadata> {
    ...
    const fallbackMetaTitle = 'Coming Soon - Toolinger | Exciting Features Ahead';
    const fallbackMetaDescription = 'Stay tuned! New tools and features are coming soon to Toolinger. Check back regularly for updates and announcements.';
